...
// Leads with the full done-for-you MARKETING offer + free website preview.
...
function compose(L: any){
  ...
  const body = greet+"\n\nI came across "+L.business_name+" while looking at "+niche+"s in "+L.city+" — "+audit+".\n\n"
    ...
    + "If you like it, reply and I'll show you what having us run your marketing would look like — 10 minutes, no pressure. If not, keep the preview, no strings.\n\nBest,\nZaid" + FOOTER;
  return { subject, body };
}
